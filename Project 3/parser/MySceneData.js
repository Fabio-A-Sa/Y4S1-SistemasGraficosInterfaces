    ...
    constructor() {
        ...
        */
        ...
        this.descriptors["controlpoint"] = [
			...
			{name: "yy", type: "float"},
            {name: "zz", type: "float"},
            {name: "time", type: "integer", required: false, default: 0.0},
		]
        ...
        this.primitiveIds = ["cylinder", "rectangle", "triangle", "sphere", "nurbs" , "box", "model3d", "skybox", "lod", "polygon", "route", "road", "animation" ]
    }
